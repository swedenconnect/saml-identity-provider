...
import se.swedenconnect.spring.saml.idp.web.filters.IdentityProviderMetadataEndpointFilter;
 ...
 */
@Slf4j
public class IdentityProviderMetadataEndpointConfigurer extends AbstractSaml2Configurer {
   ...
   */
  IdentityProviderMetadataEndpointConfigurer(final ObjectPostProcessor<Object> objectPostProcessor) {
   ...
   * @return the {@link IdentityProviderMetadataEndpointConfigurer} for further configuration
   */
  public IdentityProviderMetadataEndpointConfigurer entityDescriptorCustomizer(
  ...
  void configure(final HttpSecurity httpSecurity) {
    ...
    final IdentityProviderMetadataEndpointFilter filter =
        new IdentityProviderMetadataEndpointFilter(container, this.requestMatcher);
